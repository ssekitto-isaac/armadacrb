        ...
        >
          ...
          <div className="relative z-10 container mx-auto px-5 md:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-5">
              ...
              <a
                href="#"
                className="inline-flex items-center gap-2 bg-white/90 backdrop-blur-sm text-primary px-7 py-4 rounded-lg font-medium hover:bg-white transition border border-gray-200"
              >
                Download Free Resources <ArrowRight className="w-5 h-5" />
              </a>
            </div>
          </div>
        </section>
