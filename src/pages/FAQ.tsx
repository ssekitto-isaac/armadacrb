      ...
      <main className="flex-grow">
        ...
        <section className="relative h-[420px] md:h-[520px] overflow-hidden">
          ...
          <div className="absolute inset-0 pointer-events-none">
            <Shield className="absolute top-[20%] left-[12%] w-14 h-14 md:w-16 md:h-16 text-secondary/40 animate-float-slow" />
            <FileCheck className="absolute bottom-[25%] right-[12%] w-16 h-16 md:w-20 md:h-20 text-accent/30 animate-float" />
          </div>
        ...
        {/* Help CTA – background image, NO full overlay */}
        <section
          className="relative py-16 bg-cover bg-center bg-no-repeat text-foreground"
          style={{ backgroundImage: `url(${heroImage})` }}
        >
          {/* Subtle semi-transparent backdrop behind content */}
          ...
          <div className="relative z-10 container mx-auto px-5 md:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-5">
              <a
                href="tel:0800280180"
                className="inline-flex items-center gap-3 bg-primary text-primary-foreground px-8 py-4 rounded-full font-semibold hover:bg-primary/90 transition shadow-md"
              >
                <Phone className="w-5 h-5" />
              ...
              <a
                href="#"
                className="inline-flex items-center gap-3 bg-white/90 backdrop-blur-sm text-primary px-8 py-4 rounded-lg font-medium hover:bg-white transition border border-gray-200 shadow-sm"
              >
                Contact Support
