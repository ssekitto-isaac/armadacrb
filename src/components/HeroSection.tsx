...
const HeroSection = ({ variant = "home" }: { variant?: HeroVariant }) => {
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-28 py-28">
        <div className="max-w-3xl animate-fade-in">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-heading font-bold text-primary-foreground mb-6 animate-slide-in-left">
