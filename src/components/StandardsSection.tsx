...
const cards = [
  {
    ...
    title: "About Us",
    description:
      "We focus on stakeholder relations and astute partnership building.",
    link: "#about",
  },
  {
    icon: Eye,
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-muted-foreground">
            Operations is beyond garbage-in, garbage-out. That is why we combine
            the power of data science and analytics to deliver value-creating
            insights that enable businesses and individuals to make better
            decisions.
          </p>
        </div>
            ...
            return (
              ...
              >
                <div className="icon-circle-outline mx-auto">
                  <Icon className="w-8 h-8 text-primary group-hover:text-navy transition-colors" />
                </div>
